...
| Inteligencia de Precios (beta) | `0025`, `0026`, `0027`-`0029` (cuota por plan) | Solo Plan Hotel, por feature flag. Fase 1 de un desarrollo por etapas — ver [[Inteligencia-de-Precios]]. |
