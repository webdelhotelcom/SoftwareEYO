...
- [[Configurador-Arma-tu-Bestoic]] — reemplazo de los 4 planes fijos por un configurador real: catálogo de 17 módulos, cupo por plan, Bestoic Core, checkout gateado por Mercado Pago/WhatsApp según haya excedente sin precio definido. Implementado y verificado en vivo (2026-09-04).
- [[Rediseno-Visual-Publico-2026-09]] — reorganización de `index.html`/`software.html` en un solo recorrido de scroll, paleta 80/15/5 (blanco/navy/naranja), inspirado en agrocloud.com.uy solo en simplicidad visual. Configurador intacto. Implementado, verificado, deploy pendiente (2026-09-05).
